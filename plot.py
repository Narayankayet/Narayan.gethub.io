...
sites = (r"D:\Field sampling map/go_pro_envi_sampling.shp")
os.environ['PROJ_LIB'] =(r'C:\Users\narayan\anaconda3\envs\rsgis\Library\share\proj')
...
for feature in lyr:
    ...
    utm_coordinate_pairs[feature['CLASS_ID']] = (geom.GetX(), geom.GetY()) 
    geom.Transform(xytransform)                                       
    ll_coordinate_pairs[feature['CLASS_ID']] = (geom.GetX(), geom.GetY())  
